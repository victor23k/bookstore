defmodule Bookstore.PeopleTest do
  ...
  describe "authors" do
    ...
    test "create_author/1 with valid data creates a author" do
      valid_attrs = %{name: "some name", dead: ~D[2024-02-12], surname: "some surname", born: ~D[2024-02-12], birth_place: "some birth_place", death_place: "some death_place"}
    ...
    test "update_author/2 with valid data updates the author" do
      author = author_fixture()
      update_attrs = %{name: "some updated name", dead: ~D[2024-02-13], surname: "some updated surname", born: ~D[2024-02-13], birth_place: "some updated birth_place", death_place: "some updated death_place"}
